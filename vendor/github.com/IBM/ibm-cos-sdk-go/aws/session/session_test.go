...
//// failed to load assume role for assume_role_invalid_source_profile_role_arn,
//// source profile has no shared credentials
...
//
//	logger := bytes.Buffer{}
//	s, err := NewSession(&aws.Config{Logger: &mockLogger{&logger}})
//
//	if s == nil {
//		t.Errorf("expect not nil")
//	}
