...
CGO_ENABLED=0 go install -v -ldflags "-X main.Version=${git_commit_id} -X main.Build=${build_date}" github.com/IBM/ibmcloud-object-storage-plugin/cmd/driver
CGO_ENABLED=0 go install -v github.com/IBM/ibmcloud-object-storage-plugin/cmd/provisioner
